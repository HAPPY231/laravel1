    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-8 order-md-2 col-lg-9">
                    ...
                    <div class="row sorting mb-5 mt-5">
                        <div class="col-12">
                            ...
                            <div class="dropdown float-md-right">
                                <a class="btn btn-light btn-lg dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">5 <span class="caret"></span></a>
                ...
                <h3 class="mt-0 mb-5">{{__('logowanie.welcome.products')}} <span class="text-primary">{{count($products)}}</span></h3>
                <h6 class="text-uppercase font-weight-bold mb-3">{{__('logowanie.welcome.categories')}}</h6>
                ...
                <h6 class="text-uppercase mt-5 mb-3 font-weight-bold">{{__('logowanie.welcome.price')}}</h6>
                ...
                <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
                <a href="#" class="btn btn-lg btn-block btn-primary mt-5" id="filter-button">{{__('logowanie.welcome.filter')}}</a>
            </form>
